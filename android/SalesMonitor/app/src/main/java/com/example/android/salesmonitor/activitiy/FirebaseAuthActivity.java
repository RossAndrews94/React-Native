        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        SalesMonitorApp.getInstance().initFirebaseData();
...
//            String uid = user.getUid();
    ...
    public void shopSelected(View view) {
        FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
        if (user != null) {
            // Name, email address, and profile photo Url
//            String name = user.getDisplayName();
            ...
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference(FirebaseNames.getInfoName(email));
            userRef.setValue(FirebaseNames.COACH_ROLE);

            final DatabaseReference couchesRef = FirebaseDatabase.getInstance().getReference(FirebaseNames.COACHES);
            boolean added = false;
